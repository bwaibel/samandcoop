...
<head>
  ...
  <script type="text/javascript" src="wp-content/themes/samandcoop/avascripts/main.js"></script>
...
<body <?php body_class(); ?>>
  ...
  <div id="header">
    <a href="<?php echo home_url(); ?>" id="home">
      <img src="wp-content/themes/samandcoop/images/logo_03.png" alt="<?php bloginfo( 'name' ); ?>" />
    </a>
  </div>
